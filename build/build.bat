...
mvn clean package ^
&& "C:\Program Files\Java\graalvm-jdk-23.0.2+7.1\bin\java.exe" -agentlib:native-image-agent=config-output-dir=src/main/resources/META-INF/native-image -jar target/jaygin-0.1.jar ^
