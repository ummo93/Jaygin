...
mvn clean package ^
&& "C:\Program Files\Java\graalvm-jdk-21.0.6+8.1\bin\java.exe" -agentlib:native-image-agent=config-output-dir=general/src/main/resources/META-INF/native-image -jar general/target/jaygin.jar ^
